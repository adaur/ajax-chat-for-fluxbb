<div id="ajaxChatContent">
    ...
    <div id="ajaxChatInputFieldContainer">
			...
			<thead>
				<tr>
					<th scope="col"><script type="text/javascript">document.write(ajaxChatLang['message'])</script> <input id="ajaxChatInputField" type="text" maxlength="[MESSAGE_TEXT_MAX_LENGTH/]" onkeypress="ajaxChat.handleInputFieldKeyPress(event);"/> <script type="text/javascript">document.write('<input type="button" id="submitButton" value="' + ajaxChatLang['submit'] + '" onclick="ajaxChat.sendMessage();"/></th>')</script>
				</tr>
			</thead>
			</table>
	</div>
